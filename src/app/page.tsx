...
import { AlertCircle, Clock, Mail, ShieldAlert, Trophy, Twitter, User } from 'lucide-react';
...
export default function Home() {
  ...
  const handleStartQuiz = () => {
    ...
    if (username.trim() && email.trim() && xHandle.trim()) {
      ...
      const userHasTakenQuiz = leaderboard.some(entry => entry.email.toLowerCase() === email.trim().toLowerCase());
      ...
      localStorage.setItem('quizEmail', email.trim());
